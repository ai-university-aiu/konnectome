...
• konnectome_1_specification_v52.txt - SPECIFICATION. The problem defined completely before any code is written.

• konnectome_2_pseudocode_v52.txt - PSEUDOCODE, written in English Readable Code.

• konnectome_3_architecture_v52.txt - ARCHITECTURE. Components, interfaces, data model.

• konnectome_4_refinement_v52.txt - REFINEMENT. Test-driven iteration; what the tests found.

• konnectome_5_completion_v52.txt - COMPLETION. The measured state of the build.

• konnectome_6_demonstration_v52.txt - DEMONSTRATION. What can now be shown that could not be shown before.
