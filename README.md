...
15. **The tutorial** - a maintained, beginner-friendly [`docs/konnectome_tutorial`](docs/konnectome_tutorial_v27.txt), kept current and versioned under the archive discipline.
...
|---|---|---|
| 1. Specification | [`docs/konnectome_1_specification_v30.txt`](docs/konnectome_1_specification_v30.txt) | Appendix 1 |
| 2. Pseudocode | [`docs/konnectome_2_pseudocode_v30.txt`](docs/konnectome_2_pseudocode_v30.txt) | Appendix 2 |
| 3. Architecture | [`docs/konnectome_3_architecture_v30.txt`](docs/konnectome_3_architecture_v30.txt) | Appendix 3 |
| 4. Refinement | [`docs/konnectome_4_refinement_v30.txt`](docs/konnectome_4_refinement_v30.txt) | Appendix 4 |
| 5. Completion | [`docs/konnectome_5_completion_v30.txt`](docs/konnectome_5_completion_v30.txt) | Appendix 5 |
| 6. Demonstration | [`docs/konnectome_6_demonstration_v30.txt`](docs/konnectome_6_demonstration_v30.txt) | Appendix 6 |
...
konnectome/
  ...
  docs/
    ...
    konnectome_tutorial_v27.txt A complete beginner tutorial (Fifteenth Commandment), versioned.
...
The build has begun and is climbing the ladder. Twenty-nine slices have landed on `main` (twenty-seven packs, 438 tests, all green):
