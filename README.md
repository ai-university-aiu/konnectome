...
15. **The tutorial** - a maintained, beginner-friendly [`docs/konnectome_tutorial`](docs/konnectome_tutorial_v31.txt), kept current and versioned under the archive discipline.
...
|---|---|---|
| 1. Specification | [`docs/konnectome_1_specification_v33.txt`](docs/konnectome_1_specification_v33.txt) | Appendix 1 |
| 2. Pseudocode | [`docs/konnectome_2_pseudocode_v33.txt`](docs/konnectome_2_pseudocode_v33.txt) | Appendix 2 |
| 3. Architecture | [`docs/konnectome_3_architecture_v33.txt`](docs/konnectome_3_architecture_v33.txt) | Appendix 3 |
| 4. Refinement | [`docs/konnectome_4_refinement_v33.txt`](docs/konnectome_4_refinement_v33.txt) | Appendix 4 |
| 5. Completion | [`docs/konnectome_5_completion_v33.txt`](docs/konnectome_5_completion_v33.txt) | Appendix 5 |
| 6. Demonstration | [`docs/konnectome_6_demonstration_v33.txt`](docs/konnectome_6_demonstration_v33.txt) | Appendix 6 |
...
konnectome/
  ...
  packs/                       konnectome's Prolog packs, each with pack.pl, prolog/, test/.
    ...
    neuromodulator_bus/        Slice 4: the neuromodulatory broadcast bus (Component 4).
  ...
  docs/
    ...
    konnectome_tutorial_v31.txt A complete beginner tutorial (Fifteenth Commandment), versioned.
...
The build has begun and is climbing the ladder. Thirty-two slices have landed on `main` (twenty-seven packs, 472 tests, all green):
